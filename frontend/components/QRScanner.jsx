...
export function QRScanner({ onNavigateToFitting }) {
  ...
  const handleManualSearch = () => {
    if (manualInput.trim()) {
      setScanResult({ ...mockScanResult, id: manualInput.trim() });
      setManualInput('');
    }
  };
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <Button onClick={() => onNavigateToFitting(scanResult.id)} className="w-full">
                  View Full Details
                </Button>
