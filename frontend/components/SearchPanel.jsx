...
export function SearchPanel({ onNavigateToFitting }) {
  ...
  const handleItemSelect = (fittingId) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className="glass-effect border-white/20 shadow-xl cursor-pointer card-hover animate-slide-in-left transition-all duration-300 hover:transform hover:-translate-y-2" onClick={() => setSelectedStatus('critical')}>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-bold text-blue-200">Critical Fittings</p>
                <p className="text-sm text-blue-300/70">1 fitting</p>
              </div>
            </div>
          </CardContent>
        </Card>

        <Card className="glass-effect border-white/20 shadow-xl cursor-pointer card-hover animate-slide-in-left transition-all duration-300 hover:transform hover:-translate-y-2" style={{ animationDelay: '0.1s' }} onClick={() => setSelectedStatus('high-risk')}>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg animate-pulse">
                <AlertTriangle className="w-5 h-5 text-white" />
              </div>
              <div>
                <p className="font-bold text-blue-200">High Risk</p>
                <p className="text-sm text-blue-300/70">2 fittings</p>
              </div>
            </div>
          </CardContent>
        </Card>

        <Card className="glass-effect border-white/20 shadow-xl cursor-pointer card-hover animate-slide-in-left transition-all duration-300 hover:transform hover:-translate-y-2" style={{ animationDelay: '0.2s' }} onClick={() => setSelectedStatus('needs-inspection')}>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-lg animate-pulse">
                <Calendar className="w-5 h-5 text-white" />
              </div>
              <div>
                <p className="font-bold text-blue-200">Due Inspection</p>
                <p className="text-sm text-blue-300/70">2 fittings</p>
              </div>
            </div>
          </CardContent>
        ...
        <Card className="glass-effect border-white/20 shadow-xl cursor-pointer card-hover animate-slide-in-left transition-all duration-300 hover:transform hover:-translate-y-2" style={{ animationDelay: '0.3s' }} onClick={() => setSelectedStatus('healthy')}>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-gradient-to-br from-green-500 to-green-600 rounded-lg animate-pulse">
                <div className="w-5 h-5 bg-white rounded-full" />
              </div>
              <div>
                <p className="font-bold text-blue-200">Healthy</p>
                <p className="text-sm text-blue-300/70">3 fittings</p>
              </div>
            </div>
          </CardContent>
        </Card>
